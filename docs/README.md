...
**Feature map:** [function-plan.md](function-plan.md) §5. First accepted slice: [features/instruments.md](features/instruments.md) (landed `9ea2f2a`; IsActive rename `bbd0f26`). Accounts: [features/accounts.md](features/accounts.md) (`accepted`, landed 2026-09-21). Write Feature Specs one slice at a time. Do not lock columns outside the spec that owns them.
