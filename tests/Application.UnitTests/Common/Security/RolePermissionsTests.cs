...
public class RolePermissionsTests
{
    ...
    [TestCase(UserRole.SystemAdmin, "tenants.read", true)]
    ...
    [TestCase(UserRole.TenantAdmin, "tenants.read", true)]
    ...
    [TestCase(UserRole.Adviser, "tenants.read", true)]
    ...
    [TestCase(UserRole.Customer, "tenants.read", false)]
